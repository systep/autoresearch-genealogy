...
- **Next step**: (1) Search 1860 census for "Corbin King" in Greenville/Anderson County. (2) Search 1840 census for James King in Anderson County to count household members by age (would reveal how many sons he had). (3) Check if Robert King (Baptist clergyman) could be "Kerben" (R/K confusion less likely but possible).
