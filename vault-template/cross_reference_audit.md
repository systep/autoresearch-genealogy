...
- **Resolved with caveats (need family confirmation)**: 2 (#5: Kopp vs Huff, #6: Panciera relationship)
...
| 3 | Church ancestor | nationality | "A faithful German" (IMG_0791) | John Stangle "Born England" (IMG_0789); James Cox born NC (WikiTree) | **Not contradictory**: (1) John Stangle's surname is confirmed German (Stengel/Stangl); "Born England" is consistent with the well-documented 1709 Palatine German migration via England (~13,000 Germans to London; children born on English soil to German parents). (2) The Cox surname could derive from German "Koch" (cook); iGENEA and checkcharm.com document Koch→Cox as an attested anglicization, and Jacob Koch is recorded in North Carolina as early as 1722. (3) The note may conflate two ancestors: Cox as land donor, Stangle as the German line. All three explanations resolve the apparent conflict. | Family note vs. handwritten notes vs. WikiTree; Palatine migration (NPS, Penn State, British Library); Koch→Cox (iGENEA, FamilyTreeDNA Cox DNA Study) | **RESOLVED: Not a true conflict; German ethnicity and English birthplace are compatible via Palatine migration; Koch→Cox anglicization documented; or note conflates two family lines** |
...
| 7 | Jerrold Salmanson | parentage | Samuel's obit: "nephew" | Thelma's memorial: not listed as her child; b. 1942, marriage 1947 | **Jerrold A. Salmanson is the son of Charles Salmanson (1914-2008) and Hannah Kushner Salmanson (1914-2001).** Evidence: (a) Hannah Kushner Salmanson's Find a Grave memorial (#185239892) and obituary explicitly list "Jerrold A. Salmanson of Providence" as her surviving child; (b) Charles Salmanson's 2008 obituary confirms he was survived by son Jerrold A. and daughter Deborah (Roberts); (c) RI Foundation scholarship page states "Jerry's father and uncles founded Adams Drug Co."; (d) Jerrold's own 2024 obituary (Boston Globe) confirms family connections. Samuel's obit calls both Jerrold and Alan "nephews" because they are sons of two different brothers: Jerrold = Charles's son, Alan = Leonard's son. | Hannah Kushner Salmanson obit + Find a Grave (strong), Charles Salmanson obit (strong), RI Foundation (moderate), Jerrold Salmanson obit 2024 (strong) | **RESOLVED: Jerrold is Charles and Hannah (Kushner) Salmanson's son. Also discovered sibling: Deborah Salmanson Roberts. Family_Tree.md corrected.** |
...
- RESOLVED: Jerrold is **Charles and Hannah (Kushner) Salmanson's son**, not Leonard's. Hannah's obituary and Find a Grave memorial explicitly list Jerrold A. Salmanson as her child. Charles's 2008 obituary confirms. Not listed on Thelma's memorial because he's Charles's son, not Leonard's. Samuel's obit calls both Jerrold and Alan "nephews" (sons of two different brothers). → Discrepancy #7 RESOLVED
...
- Dates: AncientFaces ✓, Charles obit (Legacy.com) ✓
- Wife: Hannah Kushner -- Find a Grave #185239892 ✓
- Children: **Jerrold A. Salmanson**, **Deborah Salmanson Roberts** -- Hannah's obit ✓, Charles's obit ✓, RI Foundation ✓
- CONSISTENCY: Charles (1914) and Hannah (1914) same birth year ✓; Jerrold born 1942 (parents age ~28) ✓
