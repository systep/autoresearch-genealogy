...
- **Fact-level resolved**: 27 (+3 added 2026-05-02: #72 name harmonization, #73 Ezekiel marriage place to NC, #74 Hiram Cooley children list)
- **Fact-level open**: 22 (+1 deferred 2026-05-02: #71 Tabitha Dolby birth year)
...
|---|--------|-------|-------------------|-------------------|---------------|-----------------|--------|
| 71 | [[Tabitha_Dolby]] | birth_year | "c. 1750" (Family_Tree.md line 481) | 20 April 1756 (WikiTree Dolby-84, Find a Grave #48870181) | 1756 is more specific; both Tier 3. **DISCREPANCY persists per Guard Rail #3** (no Family_Tree edits during expansion sessions). Family_Tree.md already cross-references the person file. | WikiTree Dolby-84 (Tier 3) + Find a Grave #48870181 (Tier 2) | **DEFER**: leave both values; resolve in next audit pass when a Tier 2+ source (Find a Grave full memorial text, not blocked from human browser) is retrieved. |
