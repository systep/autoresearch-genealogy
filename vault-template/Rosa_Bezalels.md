...
| Field | Value | Source |
|---|---|---|
| Full Name | Rosa Bezalels | Geni curated tree |
| Died | 1651, Prague, Hlavní město Praha, Prague, Czechia (Czech Republic) | Geni |

## Biography

Person attested only in the Geni curated World Family Tree ("Shneur Zalman of Liadi" project, exported Apr 19, 2026). Appears at generation(s) 6 (ancestor) of [[Shneur_Zalman_of_Liadi]].
...
|---|---|---|
| Geni curated World Family Tree (Apr 19, 2026 export) | online tree (Tier 2-3) | [[Shneur_Zalman_Liadi_Geni_Ancestors_20gen_2026]]; Geni entry: "Rosa Bezalels" d. 1651, Prague, Hlavní město Praha, Prague, Czechia (Czech Republic) |
