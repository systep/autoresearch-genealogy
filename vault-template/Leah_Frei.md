...
Confidence: Moderate. The Yichus narrative (Tier 2, primary family document) provides birth year, death year, sisters, lineage, and full children's list, corroborating and substantially expanding upon the GEDCOM data (Tier 3).

## Document Sources

| Document | Type | Vault Note |
|---|---|---|
| GEDCOM (MyHeritage, entry I500053) | family tree database | |
