...
**Ship manifest status (2026-04-14):** Not yet located. Extensive web searching (15 queries) across free databases returned no manifest. All primary passenger list databases (Ancestry collection 7488, FamilySearch T715, Ellis Island Foundation, JewishGen EIDB) require login or subscription for individual record access. The manifest likely exists in NARA microfilm T715 (New York Passenger and Crew Lists, 1925-1957). Spelling variants to search: Markel, Markiel, Markl, Merkl; also try Helen's maiden name Brandt. The family likely sailed on one of the Polish ships (SS Polonia, SS Kosciuszko, or SS Pulaski) operating the Gdynia-Copenhagen-New York route, or a major liner from Bremen or Hamburg. Morris entered claiming to fill a rabbinical position (Yichus), which may have been noted on the manifest as his occupation or visa category. The 1940 Census lists Morris's citizenship status as "4" (interpretation uncertain; may indicate naturalized, or status unknown to enumerator). His **naturalization petition** (Rhode Island U.S. District Court, NARA Boston/Waltham) would list the exact arrival date, port, and ship name, and is the single best alternative route to locating the manifest.
...
**Immigration search update (2026-04-18, Prompt 11 session):** Conducted 30 systematic searches across Ellis Island Foundation, Steve Morse One-Step, JewishGen EIDB, GG Archives, Chronicling America, FamilySearch, Ancestry references, NARA, PolishRoots, and general web. **No passenger manifest located.** All primary databases require authentication. Steve Morse One-Step Gold Form (stevemorse.org/ellis/passengers.php) confirmed operational with Daitch-Mokotoff Soundex, ship name, and town-of-origin search fields, but requires Ancestry subscription. Polish ships operating Gdynia-Copenhagen-New York route in 1926-1928 (SS Kosciuszko, SS Polonia, SS Pulaski) not individually searchable without subscription. FamilySearch collection 2622566 (RI Naturalization Records 1907-1991, FREE with login) identified as the highest-priority path: a post-1906 naturalization petition would list arrival date, port, ship name, and exact birthplace. Also try FamilySearch collection 2141014 (RI District Court Naturalization Indexes) and Ancestry collection 61208 (RI State and Federal Naturalization Records 1802-1945).
...
**Updated 2026-04-18 (late-night session)**: A JewishRhody.com article on Ahavath Sholom (Tier 2) provides additional confirmation: the congregation explicitly "could not afford a rabbi." A Hebrew teacher served dual roles (teaching and leading prayers). Founding families were Sternbach, Shapiro, and Frank -- **no Markel family is mentioned** among the founders. This is consistent with the Markel family arriving ~1928 (after the 1919 charter). The congregation operated **without professional rabbinical leadership throughout its entire history** (1919 to ~1970s). Morris's role was almost certainly that of a **lay religious leader** (ba'al kriah, shaliach tzibbur, or community scholar), elevated to "rabbi" in family retelling.
...
> **Referenced as "Moishe Myer" in the identification key (top-row #1, middle-row #9, middle-row #11) and as "Moishe Myer Markel" (middle-row #9). His **wife** [[Helen_Brandt|Helen Brandt Markel]] is middle-row #10 ("Helen Brandt Markel — Moishe Myer's wife"). His **mother** [[Leah_Frei]] is middle-row #9 ("Leah Frei Markel — Moishe Myer's mother"). His **daughters** are bottom-row #12-15: [[Frieda_Rita_Markel]] (#12), [[Anne_Markel]] (#13), [[Kate_Markel_Kaplan]] (#14, "Kaye Markel"), [[Thelma_Markel]] (#15).**

**Photograph dating implication via Morris's family**: All four daughters identified appear in the bottom row. Joseph Harold (b. ~1932) is NOT identified in the key and is not visible as a child in the bottom row, suggesting the photograph **predates his birth** — placing it before c. 1932. Combined with Kate's December 1925 birth, the photograph window is **late 1925 through 1931**, most likely **1926-1928** (consistent with the family's documented emigration c. 1928 and the apparent ages of the bottom-row children, ~1-6). Whether the sitting was in Galicia (before emigration) or the United States (after emigration but before 1932) remains open — see [[Markel_Family_Portrait_Identification_Key]] §Photograph Setting and Dating. The presence of Pessel Markel in the photo (who never emigrated) argues **strongly for Galicia**, 1929 (per family annotation).
