...
Heshel Markel was born in 1862 (Tier 2). If Dov fathered Heshel at approximately age 22 to 32, Dov was likely born c. 1830 to 1840. This places Dov squarely within the period covered by surviving Sambor Jewish vital records (most registers date from the 1830s onward). His birth, marriage, and death records may exist in the Sambor Jewish metrical books at TsDIAL Fond 701 (Lviv) or AGAD Fond 300 (Warsaw).

### The Name "Dov"

"Dov" (Hebrew: bear) is a traditional Ashkenazic Jewish given name. It is commonly paired with the Yiddish equivalent "Ber" or "Berish." In civil records, Dov may appear as "Ber," "Berko," "Behr," or "Bernard." The Elizabeth Salmanson headstone Hebrew inscription mentions "Zavel" and "Dov Beer" (or "Dov Berer"), though the relationship of this inscription to the Markel line (as opposed to the Deych/Zalmanson line) remains unclear. See [[Open_Questions]] #19 for the headstone parsing question.

### Waniowice Civil Records
...
### Database Searches Attempted

All major databases were searched for Dov Markel; none returned positive results through web search. Programmatic access to the following databases was blocked (403 errors); human action is required to search them in a browser:

1. **Gesher Galicia All Galicia Database** (search.geshergalicia.org): Search for "Markel" in Sambor. If Dov was born c. 1830 to 1840, his birth record may be in the indexed registers.
2. **JRI-Poland** (jri-poland.org/town/sambor/): Check Sambor surname list for Markel.
3. **AGAD Warsaw** (agad.gov.pl): Browse Sambor Jewish metrical books (Fond 300) for Markel entries.
4. **FamilySearch** (collection #4426190, Ukraine Lviv Metrical Books): Browse for Sambor Jewish records.
5. **Yad Vashem** (collections.yadvashem.org/en/names): Pages of Testimony for Markel Holocaust victims from Sambor may list Dov as a grandparent or great-grandparent.

### Negative Results

1. Web search "Dov Markel" OR "Dow Markel" OR "Ber Markel" Galicia Sambor Waniowice: no match.
2. Geni.com: no Dov Markel profile in the Jewish Communities of Galicia project.
3. Web search for Markel in Sambor vital record indexes: no indexed individual result visible in web search snippets.

## Document Sources

| Document | Type | Vault Note |
|---|---|---|
| GEDCOM (MyHeritage, entry I500078) | family tree database | |
| MyHeritage Person Discovery | user-contributed tree | |
...
|---|---|---|---|
| Father | Unknown (GEDCOM) | Nissen Mendel Markel (Yichus narrative, Tier 2) | Yichus provides new data not present in GEDCOM. No contradiction. |
| Children | Heshel only (GEDCOM) | Heshel + Mattis (Yichus narrative, Tier 2) | Yichus provides additional son Mattis not in GEDCOM. No contradiction. |

## Next Steps (HUMAN ACTION REQUIRED)

1. **Search the All Galicia Database** for "Markel" in Sambor. Dov's estimated birth c. 1830 to 1840 falls within the surviving register period.
2. **Search AGAD scans** for Sambor Jewish birth registers from the 1830s to 1840s for a Markel birth.
3. **Search for Heshel's 1878 marriage record** in Sambor registers, which would name Dov as Heshel's father and potentially provide Dov's age, occupation, and residence.
4. **Search Yad Vashem** for Markel Pages of Testimony, which may list grandparents.
5. Search variant spellings: Markel, Markl, Merkl, Merkel; given names: Dov, Ber, Berko, Behr, Beer.
