...
**Probable Regiment**: Based on the recruitment district system, Heshel was most likely conscripted into **k.u.k. Infanterieregiment "Philipp Herzog von Württemberg" Nr. 77**, whose Ergänzungsbezirk (recruitment district) was Sambor. The I. Battalion of IR 77 was stationed in Sambor; headquarters, II., and III. Battalions in Przemysl; IV. Battalion in Tuzla. The regiment was composed of 69% Ruthenians, 30% Croats/Serbs, and 1% others, though Jewish soldiers from any area were assigned across units. IR 9 (Graf Clerfait), with its II. Battalion in nearby Stryj, is another possibility. Confidence: Speculative (regiment identification based on district assignment, not a primary source).

**Birthplace identification**: "Vanyavitch" in the Yichus narrative corresponds to **Waniowice**, a village near Sambor in Galicia, confirmed by a German language genealogy forum thread on Ahnenforschung.net discussing "Tarnawa nizn, Szandrowiec und Waniowice bei Sambor in Galizien." Waniowice did not have its own civil registry; under the 1877 Austrian administrative system, Jewish vital records for Waniowice were kept at the **Sambor Jewish Administrative Center** (confirmed 2026-04-14). Heshel's 1862 birth record and 1878 marriage record to Leah Frei would therefore be in the Sambor Jewish metrical books, now held at TsDIAL Fond 701 (Lviv) and AGAD Fond 300 (Warsaw). Gesher Galicia has fully indexed Sambor records in the All Galicia Database (search.geshergalicia.org). The 1878 marriage record is the single most important lead: Galician Jewish marriage records typically name the groom's father (Dov Markel) with age and occupation.
...
**Verlustlisten search status (2026-04-14)**: Searched 40+ queries across web search engines attempting to access the following databases: digi.landesbibliothek.at, GenTeam.eu, RadixIndex.com (database #8), DES genealogy.net/ou1wk, MyHeritage (collection 10953), Ancestry (collection 70940), The World Remembers, and Geni Jewish Soldiers project. All returned 403 errors on programmatic access. These databases require browser based access with registration (GenTeam, RadixIndex) or paid subscriptions (MyHeritage, Ancestry). The RadixIndex surname index confirms that "MARKEL" exists in their databases with at least 1 record. Human action is required to search these databases via browser. See [[Research_Log]] entry for 2026-04-14 for full details and search URLs. Also identified that the Jewish Military Chaplaincy records (covering marriage and death records of Jewish soldiers from Galicia) may contain Heshel's death record.

Confidence: Moderate. The Yichus narrative (Tier 2, primary family document) corroborates and substantially expands upon the GEDCOM/MyHeritage data (Tier 3). The "Polish army" reference is corrected to Austro-Hungarian army based on historical context (Strong Signal). Regiment and birthplace identifications are Speculative (based on geographic analysis, not primary records).
